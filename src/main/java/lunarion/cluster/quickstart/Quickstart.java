...
public class Quickstart {
  ...
  public static void main(String[] args) throws Exception {
    ...
    instanceConfig.setPort("" + port);
    instanceConfig.setInstanceEnabled(true);
    echo("ADDING NEW remote NODE :" + instanceConfig.getInstanceName()
    ...
    Thread.sleep(10000);
    printState("After starting 4 nodes at remote port: " + port);
    Thread.sleep(10000);
    printState("After starting 5 nodes at remote port: " + port);
    Thread.sleep(10000);
    printState("After starting 6 nodes at remote port: " + port);
    admin.rebalance(CLUSTER_NAME, RESOURCE_NAME, NUM_NODES);
    Thread.sleep(10000);
    printState("State after rebalancing ");
