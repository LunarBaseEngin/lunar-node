...
public class ExampleMasterSlaveStateModelFactory extends StateModelFactory<StateModel> {
  int _delay;
  String _instanceName = "";

  public ExampleMasterSlaveStateModelFactory(int delay) {
    _delay = delay;
  }

  public ExampleMasterSlaveStateModelFactory(String instanceName) {
    _instanceName = instanceName;
    _delay = 10;
  }

  public ExampleMasterSlaveStateModelFactory(String instanceName, int delay) {
    _instanceName = instanceName;
    _delay = delay;
  }

  public ExampleMasterSlaveStateModelFactory() {
    this(10);
  }
