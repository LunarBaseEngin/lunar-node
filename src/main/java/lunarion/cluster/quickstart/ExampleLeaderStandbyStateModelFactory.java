...
public class ExampleLeaderStandbyStateModelFactory extends StateModelFactory<StateModel> {
  int _delay;
  String _instanceName = "";

  public ExampleLeaderStandbyStateModelFactory(int delay) {
    _delay = delay;
  }

  public ExampleLeaderStandbyStateModelFactory(String instanceName) {
    _instanceName = instanceName;
    _delay = 10;
  }

  public ExampleLeaderStandbyStateModelFactory(String instanceName, int delay) {
    _instanceName = instanceName;
    _delay = delay;
  }

  public ExampleLeaderStandbyStateModelFactory() {
    this(10);
  }
