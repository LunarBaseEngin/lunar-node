...
public class ExampleOnlineOfflineStateModelFactory extends StateModelFactory<StateModel> {
  int _delay;
  String _instanceName = "";

  public ExampleOnlineOfflineStateModelFactory(int delay) {
    _delay = delay;
  }

  public ExampleOnlineOfflineStateModelFactory(String instanceName) {
    _instanceName = instanceName;
    _delay = 10;
  }

  public ExampleOnlineOfflineStateModelFactory(String instanceName, int delay) {
    _instanceName = instanceName;
    _delay = delay;
  }

  public ExampleOnlineOfflineStateModelFactory() {
    this(10);
  }
