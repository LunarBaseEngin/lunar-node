...
public class ExampleProcess {
  ...
  public void start() throws Exception {
    ...
    if ("MasterSlave".equalsIgnoreCase(stateModelType)) {
      stateModelFactory = new ExampleMasterSlaveStateModelFactory(this.instanceName, delay);
    } else if ("OnlineOffline".equalsIgnoreCase(stateModelType)) {
      stateModelFactory = new ExampleOnlineOfflineStateModelFactory(this.instanceName, delay);
    } else if ("LeaderStandby".equalsIgnoreCase(stateModelType)) {
      stateModelFactory = new ExampleLeaderStandbyStateModelFactory(this.instanceName, delay);
    }
