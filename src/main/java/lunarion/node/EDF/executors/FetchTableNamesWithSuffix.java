...
public class FetchTableNamesWithSuffix implements ExecutorInterface{
	...
	public MessageResponse execute(LunarDBServerStandAlone l_db_ssa , MessageRequest msg, Logger logger)
	{
		 ...
		 return fetchTableNamesWithSuffix(l_db_ssa, msg, logger);
	}

	
	private MessageResponse fetchTableNamesWithSuffix(LunarDBServerStandAlone l_db_ssa , MessageRequest request, Logger logger)
	{
    	...
    	MessageResponse response = null;
	        ...
	        if(l_DB == null)
	        {  
	        	response = ExecutorInterface.responseError(request, db, table_suffix, CodeSucceed.db_does_not_exist);
	        	return response;
	        } 
	        ...
	        if(names == null)
	        {
	        	response = ExecutorInterface.responseError(request, db, table_suffix, CodeSucceed.no_table_found);	
	        	return response;
	        }
