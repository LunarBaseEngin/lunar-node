...
public class TaskHandlingMessageVOld implements Runnable {
    ...
    TaskHandlingMessageVOld(MessageRequest request , 
    						ExecutorCenter node_executor_centor, 
    						ChannelHandlerContext ctx ) {
        this.request = request;
         
        this.node_tc = node_executor_centor;
        this.l_db_ssa = node_executor_centor.getActiveServer();
        this.ctx = ctx;
        this.logger = node_executor_centor.getLogger(); 
        this.result_map = node_executor_centor.getResultMap();
